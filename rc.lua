...
beautiful.init("/home/hugo/.config/awesome/themes/dust/theme.lua")
...
-- Cpu temp widget
	...
	vicious.register(tempwidget, vicious.widgets.thermal,"temp:$1°C", 20, { "coretemp.0", "core"} )
...
globalkeys = awful.util.table.join(
	...
	awful.key({ }, "XF86AudioRaiseVolume", function ()
       ...
       awful.util.spawn("amixer -q -D default sset Master toggle") end),

	awful.key({ modkey, "Shift", "Control"}, "l", function () awful.util.spawn("gnome-screensaver-command --lock") end),
    ...
    -- Print screen
    awful.key({ }, "Print", function () awful.util.spawn("scrot -e 'mv $f /home/hugo/Pictures/Screenshots/ 2>/dev/null'") end),

	--Drop-down
    awful.key ( { modkey }, "`", function() scratch.drop ( "gnome-terminal", "bottom", "center", 1, 0.25, true ) end ),
